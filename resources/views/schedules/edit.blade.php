    ...
    <div class="flex items-center justify-center">
        <form method="POST" action="/horario/{{ $schedule->id }}/edit" enctype="multipart/form-data" class="w-full max-w-md bg-white p-8 rounded-lg shadow-md mt-10">
            ...
            <div class="space-y-1 row">
                ...
                <x-forms.field class="col-12">
                    <a href="/horario/{{$schedule->id}}/edit/shift-type/create" class="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Añadir turnos</a>
                </x-forms.field>
            </div>
