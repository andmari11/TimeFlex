...
<div class="flex">
    ...
    <aside id="default-sidebar" class="min-w-[275px] top-12 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="flex flex-col h-full px-3  overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <!-- Sección principal -->
            ...
            <ul class="mt-auto mb-20 pt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                        ...
                        <span class="ms-3">Horarios General</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                        ...
                        <span class="ms-3">Formularios Anestesia</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                        ...
                        <span class="ms-3">Formularios General</span>
                    </a>
                </li>
            </ul>
        </div>
